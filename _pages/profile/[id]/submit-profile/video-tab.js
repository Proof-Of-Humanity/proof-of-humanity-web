...
export default class VideoTab extends React.Component {
    ...
    retakeVideo = () => {
        this.setState({video: null, cameraEnabled: true, recordedVideo: []})
    };
    ...
    handleStartCaptureClick = () => {
        ...
        this.mediaRecorderRef.current = new MediaRecorder(this.camera.current.stream, {mimeType: 'video/webm;codecs=h264,avc1'});
    ...
    handleDataAvailable = ({data}) => {
        ...
        this.setState({recordedVideo: this.state.recordedVideo.concat(data)});
    }
