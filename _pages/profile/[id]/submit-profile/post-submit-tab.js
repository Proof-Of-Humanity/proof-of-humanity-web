    ...
    return (
      <Row style={{ display: "block", margin: "0 auto" }}>
        <Space direction="vertical">
          <Title level={4}>
            Your submission was sent and it will soon be confirmed on the
            blockchain.
          </Title>
          ...
          <List>
            <List.Item>
              Share the link to your profile with someone who is already
              registered.
            </List.Item>
            <List.Item>
              Join the crowdvoucher group on{" "}
              <Link href="https://t.me/PoHCrowdvoucher" target="_blank">
                Telegram
              </Link>
            </List.Item>
            {this.props.state.crowdfund && (
              <>
                ...
                <List.Item>
                  Share the link to your profile with someone you know who is
                  able to pay for your deposit.
                </List.Item>
                <List.Item>
                  Join the crowdfunding group on{" "}
                  <Link href="https://t.me/PoHcrowdfunding" target="_blank">
                    Telegram
                  </Link>
                </List.Item>
              </>
