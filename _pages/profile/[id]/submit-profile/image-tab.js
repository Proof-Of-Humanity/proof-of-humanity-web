...
export default class ImageTab extends React.Component {
    ...
    retakePicture = () => {
        this.setState({picture: null, image: '', cameraEnabled: false, croppedImage:null, croppedAreaPixels:null, zoom:1, crop:{x:0,y:0}, rotation:0})
    }
                  ...
                  <div style={this.styles.controls}>
                    ...
                    {this.state.croppedImage? (
                      <div style={{textAlign: "center"}}>
                        ...
                        <img style={{ width: "100%" }} src={this.state.croppedImage}></img>
